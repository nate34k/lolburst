...
impl Stats {
    fn default() -> Self {
        Stats {
            q_dmg: (vec![40.0, 65.0, 90.0, 115.0, 140.0], 0.4),
            w_dmg: (vec![80.0, 120.0, 160.0, 200.0, 240.0], 0.48),
            e_dmg: (vec![80.0, 110.0, 140.0, 170.0, 200.0], 0.6),
            r_dmg: (vec![60.0, 90.0, 120.0], 0.35),
        }
    }
}
